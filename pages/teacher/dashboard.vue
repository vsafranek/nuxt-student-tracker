<template>
          ...
          <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-4">
              ...
              <button
                ...
                class="px-4 py-2 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 transition-colors flex items-center gap-2"
  ...
  const handleSettingsSaved = (settings: { inactivityTimeoutMinutes: number; allowDirectAnswers: boolean }) => {
    appSettings.value = settings
    // Settings are saved globally, so all students will use them
  }
